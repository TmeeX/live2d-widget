...
// 其他杂项设置
live2d_settings['l2dVersion']           = 'beta0.1';        // 当前版本
live2d_settings['l2dVerDate']           = '2021.6.11'; // 版本更新日期
live2d_settings['homePageUrl']          = 'auto';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.cloudmirror.club';   // 关于页地址, '{URL 网址}'
